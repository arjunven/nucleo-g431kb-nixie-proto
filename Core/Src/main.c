...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SER_Pin|SRCLK_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, nOE_Pin|RCLK_Pin|nSRCLR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SER_Pin SRCLK_Pin LD2_Pin */
  GPIO_InitStruct.Pin = SER_Pin|SRCLK_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : nOE_Pin RCLK_Pin nSRCLR_Pin */
  GPIO_InitStruct.Pin = nOE_Pin|RCLK_Pin|nSRCLR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
